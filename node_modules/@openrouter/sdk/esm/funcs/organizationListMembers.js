 ...
 */
export function organizationListMembers(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.ListOrganizationMembersRequest$outboundSchema.optional().parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result, raw] = await M.match(M.json(200, operations.ListOrganizationMembersResponse$inboundSchema, {
        key: "Result",
...
//# sourceMappingURL=organizationListMembers.js.map